...
- Recall: the regressed coefficient for the __Profitability__ factor _RMW_ have different signs for different industry sectors. It is difficult to interpret based on positive / negative corr.
